...
<body>
  <header>
    <div class="container-fluid">
      <section id="intro-header" style="background-image: url('pics/Land.jpg'); background-size: cover; height: 600px;">
      ...
      <div class="row scroll-horizontal-1">
        <?php for($a=0; $a<6; $a++){ ?>
            <a href="#">
              <div class="col-sm-12">
                <div class="row">
                  <img src="pics/landscape.jpg" class="img-responsive">
                </div>
                <div class="row">
                  <h3>Tzsh. 4000000</h3>
                </div>
      ...
      <div class="row scroll-horizontal-1">
        <?php for($a=0; $a<6; $a++){ ?>
            <a href="#">
              <div class="col-sm-12">
                <div class="row">
                  <img src="pics/barren.jpg" class="img-responsive">
                </div>
                <div class="row">
                  <h3>Tzsh. 200000</h3>
                </div>
